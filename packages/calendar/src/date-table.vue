<script>
import fecha from 'mepoo-ui/src/utils/date';
import { range as rangeArr, getFirstDayOfMonth, getPrevMonthLastDays, getMonthDays, getI18nSettings, validateRangeInOneMonth } from 'mepoo-ui/src/utils/date-util';
